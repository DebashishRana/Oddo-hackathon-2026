    ...
    <section id="features" className="py-24 bg-black text-foreground overflow-hidden">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-24 mb-16 md:mt-32 md:mb-20 text-center max-w-3xl mx-auto">
          ...
          >
            <Button 
              className="rounded-full px-8 bg-white hover:bg-white/90 text-black font-semibold h-12" 
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {featuresTop.map((feature, idx) => (
              ...
              >
                <div 
                  className={`aspect-[4/3] rounded-t-3xl overflow-hidden bg-slate-900 border border-white/10 relative`}
                >
                  <div 
                    className="absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-purple-500/5 pointer-events-none" 
                  />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuresBottom.map((feature, idx) => (
              ...
              >
                <div 
                  className={`aspect-[4/3] rounded-t-3xl overflow-hidden border border-white/10 relative ${feature.bgColor} bg-opacity-20`}
                >
        ...
        >
          ...
          <div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg aspect-square bg-[radial-gradient(ellipse_at_center,rgba(56,189,248,0.4),rgba(59,130,246,0.2),transparent_70%)] blur-[80px] pointer-events-none" 
          />
          <div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md aspect-square bg-[radial-gradient(ellipse_at_center,rgba(52,211,153,0.3),transparent_60%)] blur-[60px] pointer-events-none mix-blend-screen" 
          />
          <div className="relative z-10 max-w-2xl mx-auto space-y-8">
            ...
            <div className="pt-4">
              <Button 
                className="rounded-full px-8 bg-white hover:bg-white/90 text-black h-12 text-sm font-semibold transition-all duration-300" 
                whileHover={{ scale: 1.05 }}
              >
                Explore Dectra AI
              </Button>
